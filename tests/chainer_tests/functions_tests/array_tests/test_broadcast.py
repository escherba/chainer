...
@testing.parameterize(
    ...
    {'in_shapes': [(3, 1, 5), (1, 2, 5), (3, 2, 1)],
     'out_shape': (3, 2, 5), 'dtype': numpy.float32},
    {'in_shapes': [(3, 1, 5), (1, 2, 5)], 'out_shape': (3, 2, 5),
     'dtype': numpy.float16},
    {'in_shapes': [(3, 1, 5), (1, 2, 5)], 'out_shape': (3, 2, 5),
     'dtype': numpy.float64},
...
@testing.parameterize(
    {'in_shape': (3, 1, 5), 'out_shape': (3, 2, 5), 'dtype': numpy.float32},
    {'in_shape': (5,),      'out_shape': (3, 2, 5), 'dtype': numpy.float32},
    {'in_shape': (3, 2, 5), 'out_shape': (3, 2, 5), 'dtype': numpy.float32},
    {'in_shape': (3, 1, 5), 'out_shape': (3, 2, 5), 'dtype': numpy.float16},
    {'in_shape': (3, 1, 5), 'out_shape': (3, 2, 5), 'dtype': numpy.float64},
)
